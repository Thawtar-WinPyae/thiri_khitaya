...
<div class="container">
    <div class="row">
        <h2 class="col-12 text-center my-5">Our Events</h2>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div>
                                                <p>{!! $wp->description !!} </p>
                                                <h5 class="badge badge-success" style="font-size: 17px">Start Date : {{ $wp->start}} </h5>
                                                <h5 class="badge badge-danger" style="font-size: 17px">End Date : {{ $wp->end}} </h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('order.orderPackage',$wp->id)}}" class="btn btn-primary">Register Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{--                                Rating Modal start                            --}}
                            <div class="modal fade" id="exampleModal{{ $wp->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModal{{ $wp->id }}Label" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModal{{ $wp->id }}Label">Recommend This Event</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
