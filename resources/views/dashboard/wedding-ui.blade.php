                ...
                <div class="row">
                    <div class="col-12 p-0 ">
                        <nav class="navbar navbar-expand-lg navbar-dark bg-primary" >
                            <a class="navbar-brand" href="#">Thiri Khitaya</a>
                            ...
                            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto ">
                                    ...
                                    <li class="nav-item px-3 ">
                                        <a class="nav-link " href="{{ route('package.packageList') }}"><i class="fas fa-layer-group fa-fw"></i> Events</a>
                                    </li>
                                    <li class="nav-item px-3 ">
                                        <a class="nav-link" href="{{ route('blog.blogList') }}"><i class="fab fa-blogger"></i> Blog</a>
                                    </li>
                                    <li class="nav-item px-3 ">
                                        <a class="nav-link" href="{{ route('recommend.recommendList') }}"><i class="fas fa-star fa-fw"></i> Recommend</a>
                                    </li>
